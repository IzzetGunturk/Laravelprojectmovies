...
<div class="border-b border-gray-800">
    <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row">
        <div class="flex-none">
            <img src="{{ $selectedMovie->image }}" alt="{{ $selectedMovie->title }}" class="w-64 lg:w-96">
        </div>
        <div class="md:ml-24">
            <h2 class="text-4xl mt-4 md:mt-0 font-semibold">{{ $selectedMovie->title }}</h2>
    ...
    <div class="regular slider mx-auto">
        ...
        <a href="{{ route('movie.show', ['id' => $otherMovie->id]) }}"
            ...
            <div class="px-6 pt-4 pb-2">
                @foreach (explode(',', $otherMovie->tags) as $tag)
                <span
